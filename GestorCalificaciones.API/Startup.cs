...
namespace GestorCalificaciones.API
{
    public class Startup
    {
        ...
        {
            var myAppConnectionString = Configuration.GetConnectionString("GestorCalificacionesConnectionString");

            services.AddDbContext<GestorCalificacionesContext>(option =>
